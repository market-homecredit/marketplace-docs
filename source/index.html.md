...
<aside class="warning">На данный момент на Маркетплейсе действует верхняя и нижняя граница цены товаров, которые выводятся в каталог. Нижняя граница – 6000 р. (с учетом скидки), верхняя – 180000 р. (с учетом скидки).</aside>
